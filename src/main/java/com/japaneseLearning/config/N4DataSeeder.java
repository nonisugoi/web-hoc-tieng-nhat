...
public class N4DataSeeder implements CommandLineRunner {
    ...
    private final KanjiRadicalRepository kanjiRadicalRepository;
    ...
    public N4DataSeeder(CategoryRepository categoryRepository,
        ...
        this.kanjiRadicalRepository = kanjiRadicalRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        boolean courseExists = courseRepository.findAll().stream()
                .anyMatch(c -> c.getTitle().equals("Khóa học Tiếng Nhật N4"));
